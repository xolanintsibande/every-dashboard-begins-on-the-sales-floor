...
Instead of simply asking the store to give me more space, I approached the discussion around how the placement could work within the store's priorities.
...
A number tells me where to look.

Business context helps me understand why the number matters.
...
I stopped seeing a dashboard as the end of a reporting process.
...
On paper, the issue looked like a stock or replenishment problem.

But when I checked the shelf, the product was physically there.

The number was telling me something was wrong.

The shelf was telling me the problem was somewhere else.

I checked the product placement against the planogram and found the product positioned incorrectly.

The issue was not physical availability.

It was execution.

I corrected the placement, checked the surrounding shelf against the required planogram and updated the report with the correct information.
...
The dashboard gives the signal.

The sales floor gives the context.
